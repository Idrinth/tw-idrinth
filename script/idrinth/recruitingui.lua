local fixLordType = function()
    ...
    local parent = Idrinth.Ui.findElementWithin(core:get_ui_root(), {"character_panel", "character_panel_info_holder", "general_selection_panel", "main_holder", "character_list_parent", "character_list", "listview", "list_clip", "list_box"});
    if not parent then
        return;
    end;
